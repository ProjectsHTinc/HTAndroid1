...
import java.util.ArrayList;
 ...
 public class FilterSizeListAdapter extends RecyclerView.Adapter<FilterSizeListAdapter.MyViewHolder> {

     private ArrayList<FilterSize> sizeArrayList;
     Context context;
 ...
 //            }
     ...
     public FilterSizeListAdapter(ArrayList<FilterSize> SizeArrayList, OnItemClickListener onItemClickListener) {
     ...
     public void onBindViewHolder(MyViewHolder holder, int position) {
         FilterSize size = sizeArrayList.get(position);
